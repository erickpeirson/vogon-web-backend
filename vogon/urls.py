...
router.register(r'dateappellation', views.date_appellation_views.DateAppellationViewSet)
...
urlpatterns = [
    ...
    # REST Views
    path('api/v2/token/', account_views.VogonTokenObtainPairView.as_view(), name='token_obtain_pair'),
