...
from accounts.serializers import UserSerializer, CustomTokenObtainPairSerializer, ResetPasswordSerializer
...
class VogonTokenObtainPairView(TokenObtainPairView):
